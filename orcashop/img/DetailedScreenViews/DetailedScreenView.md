...
|2|ハンバーガーメニュー|メニュー表示|クリック|ドロップダウン表示| |
|3|E-mail|テキスト表示||||
|4|メール入力|テキスト入力|クリック||〇|
|5|Password|テキスト表示|||
|6|パスワード入力|テキスト入力|||〇|
|7|ログインボタン|アイコンボタン|||
|8|パスワード忘れ|テキスト表示|クリック|未定||
|9|Sign up|テキスト表示|クリック|新規登録ページへ遷移||
...
<img src="../12_サインアップ.png" width="500">
...
|4|名前入力|テキスト入力|クリック|||
|5|E-mail|テキスト表示||||
|6|メール入力|テキスト入力|クリック||〇|
|7|Password|テキスト表示|||
|8|パスワード入力|テキスト入力|クリック||〇|
|9|眼のアイコン|アイコンボタン|クリック|入力内容表示|〇|
|10|Confim password|テキスト表示|||
|11|パスワード再入力|テキスト入力|クリック||〇|
|12|眼のアイコン|アイコンボタン|クリック|入力内容表示|〇|
|13|サインアップボタン|アイコンボタン|||
|14|Login|テキスト表示|クリック|ログインページへ遷移||
...
|2|ハンバーガーメニュー|メニュー表示|クリック|ドロップダウン表示| |
|3|ウェルカムメッセージ|テキスト表示||||
|4|Login|テキスト表示|クリック||新規登録ページへ遷移|
...
<img src="../14_マイアカウント情報.png" width="500">
...
|3|My profile|テキスト表示||||
|4|Name|テキスト表示||||
|5|名前入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|6|E-mail|テキスト表示||||
|7|メールアドレス入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|8|Tel|テキスト表示||||
|9|電話番号入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|10|Default derivery address|テキスト表示||||
|11|Name|テキスト表示||||
|12|名前入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|13|Postal code|テキスト表示||||
|14|郵便番号入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|13|Address 1|テキスト表示||||
|14|住所１入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|13|Address option|テキスト表示||||
|14|住所オプション入力/出力|テキスト入力/表示|クリック|登録されていれば表示|〇|
|15|変更保存ボタン|アイコンボタン|クリック|メインページへ遷移||
|16|Password reset|テキスト表示|クリック|未定||
|17|Deret account|テキスト表示|クリック|未定||
